  ...
  return (
    <div className="flex flex-1 flex-col">
      <section className="mx-auto flex w-full max-w-2xl flex-1 flex-col items-center px-4 pb-10 pt-14 text-center sm:pt-20">
        ...
        <h1 className="mt-4 whitespace-pre-line text-3xl font-bold leading-tight sm:text-5xl">
          {t.landing.title}
        </h1>
        ...
        <div className="mt-8 flex w-full max-w-xs flex-col gap-3 sm:flex-row sm:max-w-none sm:justify-center">
          <Link
            href="/capture"
            className="rounded-lg bg-zinc-900 px-6 py-3 text-sm font-semibold text-white"
          >
            {t.landing.ctaPrimary}
          </Link>
          <a
            href="#how-it-works"
            className="rounded-lg border border-zinc-300 px-6 py-3 text-sm font-semibold text-zinc-700"
          >
            {t.landing.ctaSecondary}
          </a>
        </div>
        <p className="mt-4 text-xs text-zinc-400">{t.landing.trustLine}</p>
      </section>

      <section id="how-it-works" className="border-t border-zinc-200 bg-white py-14">
        <div className="mx-auto w-full max-w-3xl px-4">
          <h2 className="text-center text-xs font-semibold uppercase tracking-wide text-zinc-400">
